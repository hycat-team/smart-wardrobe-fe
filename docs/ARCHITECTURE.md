...
**Nguyên tắc "Kéo từ trên xuống":** Page (`app/`) sẽ import từ Feature (`features/`). Feature sẽ import từ Global (`components/`). _Tuyệt đối không làm ngược lại (Global không được import Feature)._
