...
export const metadata: Metadata = { title: "Dashboard | Không gian thương hiệu" };
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="bg-[#F5F2EE] px-4 py-2 text-xs font-bold text-black/50">
          {" "}
          Demo Data{" "}
        </div>{" "}
      </div>{" "}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {" "}
        <Card className="rounded-xl border-black/10 shadow-none">
          {" "}
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            {" "}
            <CardTitle className="text-sm font-bold text-black/60">Người theo dõi</CardTitle>{" "}
        ...
        <Card className="rounded-xl border-black/10 shadow-none">
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            {" "}
            <CardTitle className="text-sm font-bold text-black/60">Sản phẩm đã bán</CardTitle>{" "}
      ...
      <div className="bg-[#D4AF37]/10 border border-[#D4AF37]/30 p-6 flex items-start sm:items-center justify-between flex-col sm:flex-row gap-4">
        ...
        <div>
          ...
          <p className="text-black/70 text-sm mt-1">
            Sản phẩm "Luna Structured Blazer" đang được quan tâm nhiều trong tuần qua. Hãy tạo một
            chiến dịch ưu đãi cho những người đã lưu sản phẩm này.
          </p>{" "}
        </div>{" "}
        <button className="whitespace-nowrap px-6 py-3 bg-[#D4AF37] hover:bg-[#B5952F] text-white font-bold text-xs transition-colors">
          {" "}
          Tạo Campaign{" "}
        </button>{" "}
      </div>{" "}
