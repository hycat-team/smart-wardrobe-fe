import { Clock, Smartphone, Target, Shirt, AlertCircle, Sparkles } from "lucide-react";
...
export const NON_OUTFIT_CARDS: ClothData[] = [
  {
    src: "/landing-page/bottom-2.png",
    className: "cloth-card top-[30vh] left-[45vw]",
    alt: "Quần jean xanh phụ",
  },
  {
    src: "/landing-page/top-2.png",
    className: "cloth-card top-[40vh] left-[50vw]",
    alt: "Áo polo phụ",
  },
];
...
export const OUTFIT_CARDS: ClothData[] = [
  {
    src: "/landing-page/top-1.png",
    className: "cloth-card outfit-item outfit-top top-[25vh] left-[55vw]",
    alt: "Áo thun basic trắng",
  },
  {
    src: "/landing-page/bottom-1.png",
    className: "cloth-card outfit-item outfit-bottom top-[45vh] left-[40vw]",
    alt: "Quần jeans ống rộng",
  },
  {
    src: "/landing-page/shoe-1.png",
    className: "cloth-card outfit-item outfit-shoes top-[60vh] left-[60vw]",
    alt: "Giày sneaker trắng",
  },
  {
    src: "/landing-page/acc-1.png",
    className: "cloth-card outfit-item outfit-acc top-[35vh] left-[65vw]",
    alt: "Phụ kiện túi xách",
  },
];
...
export const HOW_IT_WORKS_STEPS: Step[] = [
  {
    ...
    title: "Chụp & Upload",
    description:
      "Chụp ảnh tủ đồ, AI tự động bóc tách nền, phân loại màu sắc và chất liệu cho từng món.",
  },
  {
    number: "02",
    ...
    description:
      "Nhận gợi ý phối đồ phù hợp thời tiết, hoàn cảnh và phong cách riêng của bạn mỗi ngày.",
  },
  {
    number: "03",
...
export const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      "Sẽ có gói trải nghiệm miễn phí. Bạn có thể trải nghiệm các tính năng cơ bản như số hoá tủ đồ và nhận gợi ý AI.",
  },
  {
    question: "AI phối đồ có chính xác không?",
    answer:
      "AI của Closy được huấn luyện từ hàng triệu bộ outfit và liên tục học hỏi từ phong cách của bạn. Càng dùng, AI càng hiểu gu của bạn.",
  },
  {
    question: "Dữ liệu ảnh của tôi có an toàn không?",
    answer:
      "Tuyệt đối! Ảnh của bạn được mã hoá và lưu trữ an toàn. Chúng tôi không chia sẻ dữ liệu cá nhân với bên thứ ba.",
  },
  {
    question: "Pass đồ hoạt động như thế nào?",
    answer:
      "Bạn đăng món đồ ít mặc lên marketplace. Người mua liên hệ trực tiếp qua app và thoả thuận giá cả, giao nhận.",
  },
  {
    question: "Có hỗ trợ tiếng Việt không?",
    answer:
      "Có! Closy được thiết kế hoàn toàn cho người dùng Việt Nam, từ giao diện đến AI chatbot đều hỗ trợ tiếng Việt.",
  },
];
