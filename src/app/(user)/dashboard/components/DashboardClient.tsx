  ...
  return (
    <div className="animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <h1 className="font-display-lg text-4xl md:text-5xl text-ethos-primary tracking-tight mb-2">My Wardrobe</h1>
          <p className="font-body-lg text-base text-ethos-on-surface-variant">142 items curated for you.</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div className="group bg-ethos-surface-lowest rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-ethos-outline-variant/10 cursor-pointer hover:-translate-y-1">
          <div className="relative aspect-[3/4] bg-ethos-surface-low overflow-hidden">
            ...
            <div className="absolute top-3 left-3 flex gap-2">
              <span className="bg-ethos-secondary/10 text-ethos-secondary font-label-caps text-[10px] px-2 py-1 rounded-sm backdrop-blur-md uppercase tracking-wider font-bold">
                ORGANIC SILK
              </span>
            </div>
          </div>
        ...
        <div className="group bg-ethos-surface-lowest rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-ethos-outline-variant/10 cursor-pointer hover:-translate-y-1">
          ...
          <div className="p-4">
            <h3 className="font-title-lg text-base text-ethos-primary truncate font-semibold">Pleated Wool Trousers</h3>
            <p className="font-body-sm text-sm text-ethos-on-surface-variant mt-1">The Row • Size 36</p>
          </div>
        </div>
          ...
          <div className="relative h-full min-h-[300px] bg-ethos-surface-low overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-ethos-primary/80 to-transparent flex flex-col justify-end p-6">
              <div className="flex gap-2 mb-3">
                <span className="bg-ethos-surface-lowest/20 text-ethos-on-primary font-label-caps text-[10px] px-2 py-1 rounded-sm backdrop-blur-md border border-ethos-on-primary/20 uppercase tracking-wider font-bold">
                  VINTAGE
                </span>
                <span className="bg-ethos-surface-lowest/20 text-ethos-on-primary font-label-caps text-[10px] px-2 py-1 rounded-sm backdrop-blur-md border border-ethos-on-primary/20 uppercase tracking-wider font-bold">
                  HEAVY WEAR
              ...
              <h3 className="font-display-lg text-3xl text-ethos-on-primary">Oversized Moto Jacket</h3>
              <p className="font-body-sm text-sm text-ethos-on-primary/80 mt-1">Vintage Balenciaga • One Size</p>
            </div>
          </div>
        </div>
        ...
        <div className="group bg-ethos-surface-lowest rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-ethos-outline-variant/10 cursor-pointer hover:-translate-y-1">
          ...
          <div className="p-4">
            <h3 className="font-title-lg text-base text-ethos-primary truncate font-semibold">Essential Leather Trainers</h3>
            <p className="font-body-sm text-sm text-ethos-on-surface-variant mt-1">Common Projects • Size 39</p>
          </div>
        </div>
        ...
        <div className="group bg-ethos-surface-lowest rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-ethos-outline-variant/10 cursor-pointer hover:-translate-y-1">
          ...
          <div className="p-4">
            <h3 className="font-title-lg text-base text-ethos-primary truncate font-semibold">Geometric Sunglasses</h3>
            <p className="font-body-sm text-sm text-ethos-on-surface-variant mt-1">Celine • OS</p>
          </div>
        </div>
      </div>
