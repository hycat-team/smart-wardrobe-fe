...
export function SearchClient() {
  ...
  const realItems = rawItems.filter((item: any) => {
    ...
    // AND logic: Every word typed in the search must exist somewhere in the item properties
      ...
      <div className="space-y-4">
        ...
        <form onSubmit={handleSearchSubmit} className="relative w-full">
          ...
          <input 
            ...
            className="w-full h-14 pl-12 pr-28 rounded-2xl bg-cream-dark/30 border-transparent focus:ring-1 focus:ring-terracotta focus:border-terracotta text-sm transition-all outline-none"
          />
          <Button 
            type="submit" 
