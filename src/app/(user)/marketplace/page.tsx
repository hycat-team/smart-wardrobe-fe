  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full pb-24 text-[#111]">
      ...
      <div className="flex flex-col gap-8 pt-8 md:pt-12 border-b border-black/10 pb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="space-y-4 max-w-2xl">
            {" "}
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-sans font-medium text-[#111] leading-[1.1] ">
              {" "}
              MARKETPLACE{" "}
            </h1>{" "}
            <p className="text-[12px] text-[#666] font-sans max-w-md leading-relaxed border-l-2 border-black/10 pl-4">
              {" "}
              Trao đổi, mua bán các sản phẩm thời trang bền vững và thiết kế độc bản. Kéo dài vòng
              đời của những trang phục chất lượng.{" "}
            </p>{" "}
          </div>{" "}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full md:w-auto">
            {" "}
            <button className="h-12 px-8 bg-[#111] text-white font-sans text-[11px] font-medium flex items-center justify-center gap-2 hover:bg-black/80 transition-colors">
              {" "}
              <Tag className="size-4" /> Đăng bán{" "}
            </button>{" "}
          </div>{" "}
        </div>{" "}
        {/* Filters */}{" "}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 pt-4">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4">
            ...
            {["Tất cả", "Áo khoác", "Đồ len", "Phụ kiện"].map((tab, idx) => (
              <button
                key={tab}
                className={`text-[11px] font-sans relative transition-colors group pb-1 ${idx === 0 ? "text-[#111] font-medium border-b border-[#111]" : "text-[#666] hover:text-[#111] border-b border-transparent hover:border-[#111]"}`}
              >
                {" "}
                {tab}{" "}
              </button>
          ...
          <div className="flex items-center gap-4 border border-black/10 px-4 py-2 bg-[#F8F7F5] cursor-pointer hover:bg-[#111] hover:text-white transition-colors group">
            ...
            <span className="text-[11px] font-sans text-[#111] font-medium group-hover:text-white">
              Bộ lọc
            </span>{" "}
          </div>{" "}
        </div>{" "}
          ...
          >
            ...
            <div className="relative w-full overflow-hidden bg-[#e0dcd5] aspect-[3/4] flex-shrink-0">
              ...
              <div className="absolute top-4 left-4 z-10">
                {" "}
                <span className={`text-[9px] font-sans px-3 py-1.5 ${item.badgeClass}`}>
                  {" "}
                  {item.condition}{" "}
                </span>{" "}
              </div>{" "}
              ...
              <div className="absolute inset-0 bg-white/92 opacity-0 group-hover:opacity-100 transition-opacity duration-250 flex flex-col items-center justify-end pb-8 pointer-events-none">
                {" "}
                <div className="text-black font-sans text-[11px] border-b border-black pb-0.5 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                  {" "}
                  Xem chi tiết{" "}
                </div>{" "}
              </div>{" "}
      ...
      <div className="mt-16 flex justify-center border-t border-black/10 pt-12">
        {" "}
        <button className="text-[11px] font-sans text-[#666] hover:text-[#111] transition-colors border-b border-transparent hover:border-[#111] pb-1">
          {" "}
          Tải Thêm{" "}
        </button>{" "}
      </div>{" "}
