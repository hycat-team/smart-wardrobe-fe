        ...
        <div className="relative z-10 flex-1 text-center md:text-left space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-2">
            ...
            {isPremium ? (
              ...
              <Link href="/upgrade" className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-cream-dark/50 hover:bg-terracotta/10 hover:text-terracotta border border-transparent transition-colors text-xs font-medium text-ink-muted">
                Nâng cấp Premium
              </Link>
            )}
          </div>
