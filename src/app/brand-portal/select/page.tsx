  ...
  return (
    <div className="min-h-screen bg-muted/20 flex flex-col items-center justify-center p-4 relative">
      <div className="absolute top-6 left-6 sm:top-8 sm:left-8">
        <Link href="/brands" className="flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors bg-background/50 hover:bg-background px-4 py-2 rounded-full border border-border shadow-sm backdrop-blur-sm">
