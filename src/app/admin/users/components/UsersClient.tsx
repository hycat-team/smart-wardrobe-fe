  ...
  return (
    <div className="flex flex-col gap-10 animate-in fade-in duration-500 max-w-[1400px] mx-auto w-full pb-24 text-[#111]">
        ...
        <Table>
          ...
          <TableHeader>
            ...
            <TableRow className="hover:bg-transparent border-b border-black/10">
              {" "}
              <TableHead className="font-sans text-[10px] text-[#666] py-4 h-auto w-[300px]">
                Tài khoản
              </TableHead>{" "}
              ...
              <TableHead className="font-sans text-[10px] text-[#666] text-right py-4 h-auto">
                Thao tác
              </TableHead>{" "}
            </TableRow>{" "}
          </TableHeader>{" "}
                  ...
                  >
                    ...
                    <TableCell className="py-5">
                      ...
                      <div className="flex items-center gap-4">
                        {" "}
                        <div className="size-10 bg-black/5 flex items-center justify-center font-sans text-lg text-[#111] overflow-hidden shrink-0">
                          {" "}
                          {user.avatarUrl ? (
                            <Image
                              fill
                        ...
                        <div className="flex flex-col overflow-hidden">
                          {" "}
                          <span className="font-sans font-medium text-base text-[#111] truncate">
                            {displayName}
                          </span>{" "}
                          <span className="font-sans text-[10px] text-[#666] truncate mt-0.5">
                            {user.email}
                          </span>{" "}
                        </div>{" "}
                      </div>{" "}
                    </TableCell>{" "}
                    <TableCell className="font-sans text-[12px] text-[#666] py-5">
                      {user.username}
                    </TableCell>{" "}
                    <TableCell className="font-sans text-[12px] text-[#666] py-5">
                      {" "}
                    ...
                    <TableCell className="py-5">
                      ...
                      <span
                        className={cn(
                          ...
                          isActive ? "text-[#111] border-[#111]" : "text-[#A3A3A3] border-black/10"
                        )}
                      >
                        {" "}
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuTrigger asChild>
                          ...
                          <Button
                            variant="ghost"
                            size="icon"
                            className="text-[#A3A3A3] hover:text-[#111] hover:bg-transparent rounded-xl h-8 w-8"
                          >
                            {" "}
                        ...
                        <DropdownMenuContent
                          align="end"
                          className="w-48 rounded-xl border border-black/10 bg-white p-2 shadow-sm font-sans text-[10px]"
                        >
                          {" "}
                          <DropdownMenuItem
                            className="cursor-pointer py-3 px-3 rounded-xl focus:bg-[#F8F7F5]"
            ...
            <PaginationContent>
              ...
              <PaginationItem>
                ...
                <PaginationPrevious
                  ...
                  className={
                    page <= 1
                      ? "pointer-events-none opacity-50 font-sans text-[11px] "
                      : "font-sans text-[11px] "
                  }
                  text="TRƯỚC"
                />{" "}
                  ...
                  return (
                    <PaginationItem key={pageNum}>
                      ...
                      <PaginationLink
                        ...
                        className="font-sans text-[11px] rounded-xl border-black/10"
                      >
                        {" "}
                        {pageNum}{" "}
                      </PaginationLink>{" "}
      ...
      <Dialog open={!!selectedUser} onOpenChange={(open) => !open && setSelectedUser(null)}>
        {" "}
        <DialogContent className="sm:max-w-[500px] rounded-xl border border-black/10 bg-white p-0 overflow-hidden">
          {" "}
          {selectedUser && (
            <div className="flex flex-col">
              ...
              <div className="p-8 border-b border-black/10 flex flex-col items-center gap-6">
                {" "}
                <div className="size-24 bg-black/5 flex items-center justify-center font-sans text-3xl text-[#111]">
                  {" "}
                ...
                <div className="text-center space-y-1">
                  {" "}
                  <h3 className="font-sans text-3xl font-medium text-[#111]">
                    {" "}
                    {`${selectedUser.firstName || ""} ${selectedUser.lastName || ""}`.trim() ||
                      selectedUser.username ||
                      "Người dùng"}{" "}
                  </h3>{" "}
                  <p className="font-sans text-[11px] text-[#666]">{selectedUser.email}</p>{" "}
                </div>{" "}
              </div>{" "}
              <div className="p-8 grid grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  {" "}
                  <p className="font-sans text-[10px] text-[#A3A3A3]">USERNAME</p>{" "}
                  <p className="font-sans text-[12px] text-[#111]">
                    {selectedUser.username || "N/A"}
                  </p>{" "}
                </div>{" "}
                <div className="space-y-2">
                  {" "}
                  <p className="font-sans text-[10px] text-[#A3A3A3]">ĐIỆN THOẠI</p>{" "}
                  <p className="font-sans text-[12px] text-[#111]">
                ...
                <div className="space-y-2">
                  {" "}
                  <p className="font-sans text-[10px] text-[#A3A3A3]">NGÀY THAM GIA</p>{" "}
                  <p className="font-sans text-[12px] text-[#111]">
                    {" "}
                ...
                <div className="space-y-2">
                  {" "}
                  <p className="font-sans text-[10px] text-[#A3A3A3]">TRẠNG THÁI</p>{" "}
                  <span
                    className={cn(
                      "inline-block font-sans text-[10px] font-medium border px-2 py-1 mt-1",
                      selectedUser.status === 0 || selectedUser.status === "ACTIVE"
                        ? "text-[#111] border-[#111]"
                        : "text-[#A3A3A3] border-black/10"
                    )}
                  >
                    {" "}
                    {selectedUser.status === 0 || selectedUser.status === "ACTIVE"
