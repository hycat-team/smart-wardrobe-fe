    ...
    <div className="flex flex-col gap-10 animate-in fade-in duration-500 max-w-[1400px] mx-auto w-full pb-24 text-[#111]">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-[12px] text-[#666] font-sans max-w-md leading-relaxed border-l-2 border-black/10 pl-4">
              {" "}
              Theo dõi sức khỏe và hoạt động của nền tảng. Các thông số vận hành theo thời gian
              thực.{" "}
            </p>{" "}
          </div>{" "}
        </div>{" "}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {[
          {
            label: "Người Dùng",
            value: usersLoading ? "..." : totalUsers.toLocaleString("vi-VN"),
            change: "Thực tế",
            icon: Users,
          },
          {
            label: "Cộng Đồng",
            value: postsLoading ? "..." : totalPosts.toLocaleString("vi-VN"),
            change: "Thực tế",
            icon: Sparkles,
          },
          {
            label: "Catalog",
            value: catalogLoading ? "..." : totalCatalog.toLocaleString("vi-VN"),
            change: "Thực tế",
            icon: TrendingUp,
          },
          {
            label: "Cần Duyệt (Mock)",
            value: "14",
            change: "Alert",
            icon: ShieldAlert,
            alert: true,
          ...
          <div
            key={i}
            className="bg-white border border-black/10 p-6 flex flex-col gap-6 shadow-sm relative group hover:border-black/30 transition-colors"
          >
            {" "}
            <div className="flex justify-between items-start">
              {" "}
              <span className="text-[10px] font-sans font-bold text-[#888] group-hover:text-[#111] transition-colors">
                {stat.label}
              </span>{" "}
            ...
            <div className="flex items-end justify-between">
              {" "}
              <span className="text-4xl font-sans font-medium text-[#111]">{stat.value}</span>{" "}
              <span
                className={cn(
                  "text-[9px] font-sans font-bold mb-1",
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white border border-black/10 p-6 shadow-sm">
          ...
          <div className="mb-8 border-b border-black/5 pb-4">
            {" "}
            <h3 className="font-sans text-2xl text-[#111] mb-2">Hoạt Động Tuần</h3>{" "}
            <p className="text-[10px] font-sans text-[#666]">
              Lượt dùng AI & Lưu lượng truy cập
            </p>{" "}
          </div>{" "}
        ...
        <div className="bg-white border border-black/10 p-6 shadow-sm flex flex-col">
          ...
          <div className="mb-8 border-b border-black/5 pb-4">
            {" "}
            <h3 className="font-sans text-2xl text-[#111] mb-2">Tải Hệ Thống</h3>{" "}
            <p className="text-[10px] font-sans text-[#666]">
          ...
          <div className="flex-1 flex flex-col justify-center gap-8">
            ...
            <div className="space-y-3">
              {" "}
              <div className="flex justify-between text-[11px] font-sans text-[#111] font-bold">
                {" "}
                <span>LLM Engine</span> <span>45%</span>{" "}
              </div>{" "}
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-[11px] font-sans text-[#111] font-bold">
                {" "}
                <span>Computer Vision</span> <span>78%</span>{" "}
              </div>{" "}
              <div className="h-1 w-full bg-[#F8F7F5] overflow-hidden">
                {" "}
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-[11px] font-sans text-[#111] font-bold">
                {" "}
                <span>Database Query</span> <span>12%</span>{" "}
              </div>{" "}
              <div className="h-1 w-full bg-[#F8F7F5] overflow-hidden">
                {" "}
