    ...
    <DialogContent className="sm:max-w-md bg-zinc-950 border-zinc-800 text-white rounded-3xl">
      ...
      <div className="py-6 space-y-6">
        ...
        <div className="relative">
          ...
          />
          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-500 font-medium">VNĐ</span>
        </div>
        ...
        >
          {topupMutation.isPending ? 'Đang tạo thanh toán...' : (
            <>
              <Zap size={20} className="fill-white" />
              Nạp {amount ? amount.toLocaleString('vi-VN') + 'đ' : 'Tiền'}
            </>
          )}
        </Button>
      </div>
