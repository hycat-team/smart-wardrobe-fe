...
export function OutfitCanvasBoard({
  ...
  return (
    <div className="flex-1 bg-muted/30 border border-border rounded-xl relative overflow-hidden flex items-center justify-center">
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  <div className="canvas-item-controls opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-card border border-border text-foreground flex items-center gap-0 shadow-md rounded-full z-50 whitespace-nowrap overflow-hidden">
                    <button
                      type="button"
                      onClick={(e) => { e.stopPropagation(); updateScale(item.id, item.scale - 10); }}
                      className="hover:bg-foreground hover:text-background transition-colors p-2"
                      title="Thu nhỏ"
                    >
                    ...
                    <button
                      ...
                      className="hover:bg-foreground hover:text-background transition-colors flex items-center gap-1 text-[9px] uppercase tracking-widest font-bold px-3 py-2"
                      title="Đưa lên trên"
                    >
                  ...
                  {item._role && (
                    <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap bg-card border border-border px-2.5 py-1 rounded-full shadow-sm">
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 text-[10px] font-bold text-muted-foreground bg-card px-4 py-2 rounded-full border border-border z-20 pointer-events-none shadow-sm whitespace-nowrap uppercase tracking-widest">
