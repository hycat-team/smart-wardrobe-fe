  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="rounded-full bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 shadow-xl shadow-primary/10 gap-2 h-11 px-6 font-medium tracking-wide text-[13px]" size="default">
      ...
      <DialogContent className="sm:max-w-[525px] p-0 overflow-hidden bg-surface">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          <div className="px-6 py-4 space-y-4 max-h-[60vh] overflow-y-auto no-scrollbar">
            <div>
              <input
                type="text"
            ...
            <div>
              <textarea
                placeholder="Chia sẻ phong cách, ý tưởng hoặc trải nghiệm của bạn..."
                value={content}
