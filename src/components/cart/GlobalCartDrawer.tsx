    ...
    <Sheet open={isCartOpen} onOpenChange={setCartOpen}>
      ...
      <SheetContent className="w-full sm:max-w-md p-0 flex flex-col bg-[#FAFAFA] border-l border-black/10">
        ...
        <SheetHeader className="p-6 border-b border-black/10 text-left bg-white">
          {" "}
          <SheetTitle className="font-sans text-3xl font-medium tracking-tight flex items-center gap-3">
            {" "}
            <ShoppingBag className="w-6 h-6" /> Giỏ Hàng{" "}
          </SheetTitle>{" "}
          <SheetDescription className="font-sans text-[10px] text-[#A3A3A3] flex items-center justify-between mt-2">
            {" "}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
          ...
          {cart.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-[#A3A3A3] space-y-4">
              ...
              <p className="font-sans text-xs ">Giỏ hàng trống</p>{" "}
              {/* <Button variant="outline" onClick={() => setCartOpen(false)} className="mt-4 rounded-xl border-black/20 text-[#111] hover:bg-black/5 font-sans text-[10px] " > Tiếp tục mua sắm </Button> */}{" "}
            </div>
          ) : (
              ...
              return (
                <div key={brandId} className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 pb-2 border-b border-black/5">
                    ...
                    />{" "}
                    <h3 className="font-sans font-bold text-xs text-[#111]">
                      {" "}
                      {group.brandName}{" "}
                    </h3>{" "}
                  </div>{" "}
                      ...
                      >
                        ...
                        <div className="pt-8">
                          ...
                          <input
                            ...
                            onChange={() =>
                              toggleItemSelection(item.productId, item.size, item.color)
                            }
                            className="w-4 h-4 accent-[#111] cursor-pointer"
                          />{" "}
                        </div>{" "}
                        ...
                        <div className="flex flex-col flex-1 justify-between py-1">
                          ...
                          <div>
                            ...
                            <div className="flex justify-between items-start gap-2">
                              {" "}
                              <h3 className="font-sans text-lg font-medium leading-tight text-[#111] line-clamp-2">
                                {" "}
                                {item.name}{" "}
                              </h3>{" "}
                              <button
                            ...
                            <p className="font-sans text-[10px] text-[#666] mt-1">
                              {" "}
        ...
        {cart.length > 0 && (
          <div className="p-6 border-t border-black/10 bg-white space-y-6">
            ...
            <div className="space-y-3">
              {" "}
              <div className="flex justify-between font-sans font-medium text-xs text-[#666] ">
                {" "}
              ...
              <div className="flex justify-between font-sans font-medium text-xs text-[#666] ">
                {" "}
                <span>Phí vận chuyển</span> <span>Tính lúc thanh toán</span>{" "}
              </div>{" "}
              <div className="h-px bg-black/10 w-full my-2" />{" "}
              <div className="flex justify-between font-sans text-2xl font-medium text-[#111]">
                {" "}
            ...
            >
              ...
              <Button
                ...
                className="w-full h-14 rounded-xl bg-[#111] hover:bg-black text-white font-sans text-xs font-medium transition-transform active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100"
              >
                {" "}
