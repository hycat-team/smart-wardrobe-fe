...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "group/avatar relative flex size-9 shrink-0 overflow-hidden rounded-full border border-border bg-muted select-none data-[size=lg]:size-11 data-[size=sm]:size-7",
        className,
      )}
      {...props}
    />
